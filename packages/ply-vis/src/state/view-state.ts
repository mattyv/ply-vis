...
export const initialViewState = (): ViewState => Object.freeze({ detailsHidden: true, zoom: 1, panX: 0, panY: 0, overlays: Object.freeze({ earned: true, gap: true, violation: true }) });
