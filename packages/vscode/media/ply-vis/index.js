...
}, we = (n) => Array.isArray(n) && n.every((r) => typeof r == "string"), It = /* @__PURE__ */ new Set(["declared", "earned", "gap", "violation"]);
function Se(n) {
...
function xt(n) {
  ...
  for (const [d, p] of Object.entries(n.elements)) {
    ...
    if (p.id !== d || typeof p.id != "string" || !p.id || typeof p.kind != "string" || !p.kind || typeof p.label != "string" || !p.label || typeof p.evidence.verdict != "string" || !we(p.evidence.statuses) || typeof p.evidence.reused != "boolean" || p.evidence.state !== void 0 && !It.has(p.evidence.state) || !we(p.diagnosticIds) || p.parentId !== void 0 && typeof p.parentId != "string" || p.declaration !== void 0 && typeof p.declaration != "string" || p.limitations !== void 0 && !we(p.limitations)) throw new E(`Invalid element: ${d}`);
...
const Et = /* @__PURE__ */ new Set(["script", "foreignobject", "iframe", "object", "embed", "audio", "video", "animate", "animatemotion", "animatetransform", "set"]), St = /* @__PURE__ */ new Set(["href", "xlink:href", "src"]), kt = /^(?:[.#][A-Za-z_][\w-]*|[A-Za-z][\w-]*)(?:\s+(?:[.#][A-Za-z_][\w-]*|[A-Za-z][\w-]*))*$/, Ue = /^(?:none|#[0-9a-f]{3,8}|url\(#[A-Za-z_][\w:.-]*\))$/i, At = {
  fill: Ue,
  stroke: Ue,
  "stroke-width": /^\d+(?:\.\d+)?$/,
...
function Ge(n, r = {}) {
  ...
  for (const m of [...f.querySelectorAll("*")]) {
    ...
    if (Et.has(m.localName.toLowerCase())) {
      m.remove();
      continue;
    }
    for (const b of [...m.attributes]) {
      ...
      (x.startsWith("on") || x === "style" || w || St.has(x) && h !== "" && !h.startsWith("#")) && m.removeAttribute(b.name);
    }
  }
  return new XMLSerializer().serializeToString(f.documentElement);
}
const Ie = 1, Bt = () => ({ post: (n) => window.parent.postMessage(n, "*") });
function $t(n) {
...
function Tt(n) {
  if (typeof n != "object" || n === null) return !1;
  const r = n;
  return r.channel === "ply-vis" && r.version === 1 && (r.type === "artifact" && "envelope" in r && typeof r.deliveryId == "string" || r.type === "restore-state" && $t(r.state) || r.type === "capabilities" && typeof r.explain == "boolean" || r.type === "clear" && typeof r.message == "string");
}
const Dt = () => Object.freeze({ detailsHidden: !0, zoom: 1, panX: 0, panY: 0, foldDetail: !0, hoverTooltips: !0, legendVisible: !1, optionsHidden: !1, overlays: Object.freeze({ earned: !0, gap: !0, violation: !0 }) }), Ke = (n, r) => Object.freeze({ ...n, ...r, overlays: Object.freeze({ ...n.overlays, ...r.overlays }) });
function* ae(n, r) {
...
const jt = 500, qt = 160, Je = /* @__PURE__ */ new Set(["vscode-dark", "vscode-high-contrast"]), Ht = /* @__PURE__ */ new Set(["vscode-light", "vscode-high-contrast-light"]);
function xe() {
...
const Ee = (n, r) => `<button type="button" aria-label="${n}" title="${n}">${r}</button>`, Vt = `
...
function Ft(n, r, v = []) {
  ...
  let a = Dt(), y, ne = /* @__PURE__ */ new Map(), oe, G = xe(), H;
  const ie = /* @__PURE__ */ new Set();
  let C, ke = 0, L, K, ce, le = !1, J;
  const Ae = () => r.post({ channel: "ply-vis", version: Ie, type: "persist-state", state: a }), O = (e, t = !0) => {
    a = Ke(a, e), t && Ae();
  }, F = () => {
    b.style.transform = `translate(${a.panX}px, ${a.panY}px) scale(${a.zoom})`;
  }, Qe = () => y ? Object.values(y.elements).filter((e) => !a.focusedId || e.id === a.focusedId || pe(e, a.focusedId, y.elements)) : [];
  function V() {
  ...
  function se() {
    if (x.replaceChildren(), !y || !a.legendVisible) {
      x.hidden = !0;
      return;
    }
    ...
    const s = document.createElement("ul"), i = (c, l, g) => {
      const u = document.createElement("li"), I = document.createElement("span");
      I.className = "ply-legend-swatch", I.setAttribute("aria-hidden", "true"), g.state && (I.dataset.state = g.state), g.symbol && (I.dataset.symbol = g.symbol), g.symbol === "trusted" && (I.textContent = "⛉"), g.symbol === "decision" && (I.textContent = "#");
...
Installed ${J}`
  ...
  function pe(e, t, o) {
    for (const s of ae(e.parentId ? o[e.parentId] : void 0, o)) if (s.id === t) return !0;
    return !1;
  }
  function nt(e) {
    let t = 0, o = e;
    for (const s of ae(e, y?.elements ?? {})) {
  ...
  function ot(e) {
    let t = 0;
    for (const o of ae(e, y?.elements ?? {}))
  ...
  function it() {
    ...
    const e = [];
    for (const o of ae(a.focusedId ? y.elements[a.focusedId] : void 0, y.elements)) {
      if (!o.parentId) break;
      e.unshift(o);
    }
  ...
  function Y(e) {
    ...
    if (t.textContent = e?.label ?? "Details", d.append(t), !e || !y) {
      const u = document.createElement("p");
      u.textContent = "Select an item to inspect its declaration and evidence.", d.append(u);
      return;
    }
    if ("fromId" in e) {
      d.append(M("Type", [e.kind])), d.append(M("From", [y.elements[e.fromId].label])), d.append(M("To", [y.elements[e.toId].label]));
      return;
    }
...
`).filter(Boolean);
    ...
    const c = new Map(y.diagnostics.map((u) => [u.id, u])), g = o.diagnosticIds.map((u) => c.get(u)).filter((u) => u !== void 0).map((u) => `${u.code} — ${u.severity}: ${u.message}`);
    if (d.append(M("Diagnostics", g.length ? g : ["No diagnostics supplied."])), d.append(st(y.run)), o.source) {
  ...
  function ue() {
    if (!(!y || !a.selectedId))
      return ne.get(a.selectedId) ?? y.elements[a.selectedId];
  }
  function Te(e) {
  ...
  function lt(e, t) {
    ...
    const i = 12, c = h.offsetWidth, l = h.offsetHeight, g = Math.max(s, o.width - c - s), u = Math.max(s, o.height - l - s), I = e - o.left + i, j = t - o.top + i, P = j + l <= o.height - s ? j : t - o.top - l - i;
    h.style.left = `${Math.min(g, Math.max(s, I))}px`, h.style.top = `${Math.min(u, Math.max(s, P))}px`;
  }
  function Me(e, t, o) {
    ...
    if (i) {
      ...
      const u = document.createElement("strong");
      u.textContent = s.label, l.textContent = ct(s, e).join(`
`), h.replaceChildren(u, l);
    } else
      l.textContent = c, h.replaceChildren(l);
    h.hidden = !1, dt(e);
    const g = e.getBoundingClientRect();
    lt(t ?? g.left + g.width / 2, o ?? g.bottom);
  }
  function ze(e, t, o) {
  ...
  function z() {
    if (w.hidden) return;
    const e = w.contains(document.activeElement), t = ce;
    w.hidden = !0, w.replaceChildren(), ce = void 0, e && (t?.isConnected ? t : m).focus();
  }
  function Ne() {
  ...
  function pt(e) {
    ...
    if (s && i.push({ label: `Zoom into ${s.label}`, run: () => Z(s.id) }), a.focusedId && i.push({ label: "Back to Workspace", run: () => Z(void 0) }), y) {
      const l = new Map(y.diagnostics.map((g) => [g.id, g]));
      for (const g of le ? s?.diagnosticIds ?? [] : []) {
        const u = l.get(g)?.code;
        u && i.push({ label: `Explain ${u}`, run: () => r.post({ channel: "ply-vis", version: Ie, type: "explain", code: u }) });
      }
    }
    if (t && le && i.push({ label: "Explain a code…", run: () => r.post({ channel: "ply-vis", version: Ie, type: "explain-prompt" }) }), !i.length) return;
    e.preventDefault(), S();
    const c = document.activeElement;
    ce = c instanceof HTMLElement || c instanceof SVGElement ? c : void 0, w.replaceChildren();
    for (const l of i) {
      ...
      u.type = "button", u.setAttribute("role", "menuitem"), u.textContent = l.label, u.tabIndex = -1, u.addEventListener("click", () => {
        z(), l.run();
      }), g.append(u), w.append(g);
    }
    w.hidden = !1, ft(w, e.clientX, e.clientY), me(0);
  }
  w.addEventListener("keydown", (e) => {
    ...
    e.key === "ArrowDown" ? (e.preventDefault(), me(o + 1)) : e.key === "ArrowUp" && (e.preventDefault(), me(o - 1));
  }), m.addEventListener("contextmenu", pt);
  const je = (e) => {
  ...
  function N() {
    ...
    for (const i of e) {
      const c = i.dataset.elementId ?? i.dataset.plyId ?? "", l = y.elements[c], g = te(i);
      if (g) {
        i.removeAttribute("hidden"), i.setAttribute("role", "button"), i.setAttribute("aria-label", Te(g)), i.classList.toggle("is-selected", g.id === a.selectedId);
        continue;
      }
      if (!l) {
      ...
      const u = Le(l), I = u === "declared" || a.overlays[u], j = t ? pe(t, l.id, y.elements) : !1, P = !a.focusedId || l.id === a.focusedId || pe(l, a.focusedId, y.elements) || j, de = H === void 0 || j || nt(l) <= $e();
      i.toggleAttribute("hidden", !P || !de || !I && !j);
      const wt = [l.evidence.verdict, ...l.evidence.statuses].filter(Boolean).join(", ") || "declared";
      i.setAttribute("role", "button"), i.setAttribute("aria-label", `${l.kind}: ${l.label}; ${wt}`), i.dataset.state = u, i.classList.toggle("is-selected", l.id === a.selectedId), i === L && (i.hasAttribute("hidden") || !i.isConnected) && S();
    }
    ut(), se();
  ...
  function ut() {
    ...
    for (const i of [...e.children]) {
      ...
      Mt(s, l) || (i.setAttribute("hidden", ""), i.setAttribute("data-ply-focus-hidden", ""));
    }
  }
  function mt(e) {
    X(), y = e, ne = new Map(e.edges.map((i) => [i.id, i])), O({ runId: e.run.id, selectedId: void 0, focusedId: void 0, detailsHidden: !0, zoom: 1, panX: 0, panY: 0 }, !1);
    const t = Object.keys(e.elements).length > 0;
    T.hidden = !t, D.hidden = !t, p.hidden = !t, t || Ce(!0, !1), V(), S(), z(), H = void 0, he(e.svg), m.dataset.empty = "false";
    const o = m.querySelector(".ply-empty");
    o && o.remove(), F(), N(), Y(ue());
    const s = tt(e);
    U.textContent = s.text, s.title ? U.title = s.title : U.removeAttribute("title"), k.textContent = "", typeof window.requestAnimationFrame == "function" && window.requestAnimationFrame(() => ve(!1));
  }
  function he(e) {
    b.innerHTML = e;
  ...
  function ht(e) {
    ...
    for (const s of b.querySelectorAll("[data-element-id], [data-ply-id]")) {
      ...
      const g = c.width / l.width, u = c.height / l.height;
      if (![g, u].every(Number.isFinite)) continue;
      let I;
      try {
        if (I = s.animate([
          { transform: `translate(${(c.left - l.left) / o}px, ${(c.top - l.top) / o}px) scale(${g}, ${u})`, transformOrigin: "0 0" },
          { transform: "none", transformOrigin: "0 0" }
        ], { duration: qt, easing: "ease-out", composite: "add" }), !(I.effect instanceof KeyframeEffect) || I.effect.composite !== "add") {
          I.cancel();
          continue;
        }
      } catch {
  ...
  function yt() {
    ...
    const e = gt();
    if (e === H) return;
    const t = e === void 0 ? y.svg : y.folded.find((s) => s.depth === e)?.svg;
    if (!t) {
      H = e;
      return;
    }
  ...
  function gt() {
    ...
    if (Number.isFinite(e)) {
      if (a.focusedId) {
        const t = y.elements[a.focusedId];
  ...
  function ye(e, t) {
    try {
      const o = xt(e), s = He(o);
      return oe = o, mt(s), delete f.dataset.error, t !== void 0 && r.post({
        channel: "ply-vis",
        version: 1,
  ...
  function Ve(e) {
    ...
    G = e, y = He(oe), S(), z(), X();
    const t = H === void 0 ? y.svg : y.folded.find((o) => o.depth === H)?.svg ?? y.svg;
    he(t), N(), F(), Y(ue());
  }
  function re(e) {
    const t = y && (ne.get(e) ?? y.elements[e]);
  ...
  function Z(e) {
    e && !y?.elements[e] || (e && !y.elements[e].parentId && (e = void 0), S(), z(), O({ focusedId: e, selectedId: e, detailsHidden: !e }), V(), N(), Y(e ? y?.elements[e] : void 0), ve());
  }
  function vt() {
  ...
  function ge(e, t) {
    S(), z(), X(), t ??= vt(), O(Nt(a, Math.min(4, Math.max(0.2, e)), t)), F(), N(), k.textContent = `Zoom ${Math.round(a.zoom * 100)}%`;
  }
  function ve(e = !0) {
    X();
    ...
    O(zt({ width: m.clientWidth, height: m.clientHeight }, l)), F(), N();
  }
  f.querySelector('[aria-label="Zoom in"]').addEventListener("click", () => ge(a.zoom * 1.2)), f.querySelector('[aria-label="Zoom out"]').addEventListener("click", () => ge(a.zoom / 1.2)), f.querySelector('[aria-label="Fit canvas"]').addEventListener("click", () => ve()), p.addEventListener("click", () => Ce(!a.detailsHidden)), f.querySelectorAll("[data-overlay]").forEach((e) => e.addEventListener("change", () => {
    ...
    ge(a.zoom * Math.exp(-e.deltaY * 2e-3), { x: e.clientX - t.left, y: e.clientY - t.top });
  ...
  m.addEventListener("pointerup", be), m.addEventListener("pointercancel", be), m.addEventListener("lostpointercapture", be), m.addEventListener("keydown", (e) => {
    if (e.key === "Escape" && !h.hidden) {
      e.preventDefault(), S();
      return;
    }
    const t = [...b.querySelectorAll("[data-element-id], [data-ply-id]")], o = new Set(t.filter((c) => !c.hasAttribute("hidden") && te(c)).map((c) => c.dataset.elementId ?? c.dataset.plyId)), s = [...Qe(), ...(y?.edges ?? []).filter((c) => o.has(c.id))];
    if (!s.length) return;
  ...
  function bt(e) {
    y = void 0, oe = void 0, H = void 0, a = { ...a, selectedId: void 0, focusedId: void 0, detailsHidden: !0 }, b.innerHTML = "", se(), S(), z(), m.dataset.empty = "true";
  ...
  const Be = (e) => {
    Tt(e.data) && (e.data.type === "artifact" ? ye(e.data.envelope, e.data.deliveryId) : e.data.type === "capabilities" ? (le = e.data.explain, J = e.data.installedTool) : e.data.type === "clear" ? bt(e.data.message) : (a = Ke(a, e.data.state), f.querySelectorAll("[data-overlay]").forEach((t) => {
      t.checked = a.overlays[t.dataset.overlay];
    }), f.querySelector("[data-fold-detail]").checked = a.foldDetail, f.querySelector("[data-hover-tooltips]").checked = a.hoverTooltips, f.querySelector("[data-show-legend]").checked = a.legendVisible, fe(), y && (V(), F(), N(), Y(ue()))));
  }, Fe = (e) => {
  ...
  Ze?.addEventListener("change", Pe), q.addEventListener("click", () => et(!a.optionsHidden)), V(), fe();
  for (const e of v) ye(e);
  return r.post({ channel: "ply-vis", version: 1, type: "ready" }), v.length || r.post({ channel: "ply-vis", version: 1, type: "request-artifact" }), { load: ye, getState: () => a, destroy: () => {
